          ...
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                {paginatedBeneficiaries.map((beneficiary, idx) => (
                    <tr key={beneficiary.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                ...
                {filteredBeneficiaries.length === 0 && (
                    <tr>
                      <td colSpan={7} className="text-center text-gray-400 py-8">No Beneficiaries found.</td>
                    </tr>
                )}
                </tbody>
              </table>
            ...
            <div className="w-full flex justify-end mt-4">
              <div className="flex items-center gap-2 text-sm text-gray-700 ">
                ...
                <span className="font-semibold text-[#012765] text-base ml-2">{filteredBeneficiaries.length}</span>
                <button
                    className="px-2 py-1 rounded hover:bg-gray-100 disabled:opacity-50"
                    onClick={() => setPage(page + 1)}
